...
def process_args(args):
    ...
    logger.info("bathrooms_text to float64")
    df['bathrooms_text'] = df['bathrooms_text'].str.split().str[0]
    df['bathrooms_text'] = df['bathrooms_text'].str.replace("Shared", "1")
    df['bathrooms_text'] = df['bathrooms_text'].str.replace("Half-bath", "0")
    df['bathrooms_text'] = df['bathrooms_text'].str.replace("Private", "1")
